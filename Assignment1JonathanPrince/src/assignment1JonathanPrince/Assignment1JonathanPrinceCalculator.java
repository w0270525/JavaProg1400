 ...
 * Assignment 1
 * Sales Commission Calculator – console application
 */

import java.util.Scanner;

public class Assignment1JonathanPrinceCalculator {
	...
	public static void main(String[] args) {
		...
		String number; // holder for string before determining if entry is positive integer.
		...
		// Calculation for employees weekly earnings. base salary plus commission at 9% of items sold.
		weeklyEarnings = baseSalary + (((itemOne * numberSoldOne) + (itemTwo * numberSoldTwo) + (itemThree * numberSoldThree) + (itemFour * numberSoldFour)) * (commissionPercentage /100));
		
		//  String.format( "%.2f", x) found by google search, unsure if this is what is required or using a currency import.
		System.out.println("The weekly salary for " + employee +" is $" + String.format( "%.2f", weeklyEarnings) +".");		
		
		// Option to continue with another employee. y sends true and continues through loop, n sends false and exits.
